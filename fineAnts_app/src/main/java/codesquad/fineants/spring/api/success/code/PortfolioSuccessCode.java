...
public enum PortfolioSuccessCode implements SuccessCode {
	...
	OK_MODIFY_PORTFOLIO_ACTIVE_NOTIFICATION(HttpStatus.OK, "목표수익금액의 알림이 활성화되었습니다"),
	OK_MODIFY_PORTFOLIO_INACTIVE_NOTIFICATION(HttpStatus.OK, "목표수익금액의 알림이 비활성화되었습니다");
